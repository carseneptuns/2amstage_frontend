  ...
  return (
    <footer className="border-t border-black/10 bg-surface">
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
            ...
            <div className="mt-5 flex gap-3">
              {[AtSign, MessageCircle, PlayCircle].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-black/10 text-mid transition hover:border-stage/40 hover:text-stage"
                >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-black/10 pt-6 text-xs text-dim sm:flex-row">
