  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {STAT_CARDS.map(({ key, label, icon: Icon, color, money }, i) => (
          <motion.div
            ...
            className="glass rounded-2xl border border-black/10 p-5"
          >
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="glass rounded-2xl border border-black/10 p-6 lg:col-span-2">
          ...
          {(!data?.event_terdekat || data.event_terdekat.length === 0) ? (
            ...
            <div className="space-y-3">
              {data.event_terdekat.map((e) => (
                <div
                  key={e.id}
                  className="flex items-center gap-4 rounded-xl border border-black/5 bg-surface2 p-3"
                >
        ...
        <div className="glass rounded-2xl border border-black/10 p-6">
