      ...
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[1fr_360px]">
          <div className="space-y-12">
            ...
            {/* Countdown */}
            <Reveal className="rounded-2xl border border-black/10 bg-gradient-to-br from-surface to-surface2 p-6">
            ...
            <Reveal>
              ...
              <div className="mt-6">
                {categories.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-black/15 p-10 text-center text-mid">
          ...
          <div className="lg:sticky lg:top-28 lg:h-fit">
            <Reveal className="rounded-2xl border border-black/10 bg-surface p-6">
