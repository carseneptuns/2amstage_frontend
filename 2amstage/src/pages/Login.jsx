  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-spotlight px-5 py-28">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md rounded-3xl border border-hairline/10 bg-surface/80 p-8 shadow-2xl backdrop-blur-xl sm:p-10"
      >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-hairline/10 bg-void/60 py-3 pl-11 pr-4 text-sm text-hi outline-none transition focus:border-stage/50 focus:ring-2 focus:ring-stage/20"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={onChange}
                placeholder="••••••••"
                className="w-full rounded-xl border border-hairline/10 bg-void/60 py-3 pl-11 pr-11 text-sm text-hi outline-none transition focus:border-stage/50 focus:ring-2 focus:ring-stage/20"
              />
              <button
                type="button"
