...
const STATUS_BADGE = {
  ...
  cancelled: "border-hairline/15 bg-hairline/[0.03] text-mid",
...
export default function MyTickets() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-28 sm:px-8">
        ...
        {sortedOrders.map((order, i) => {
          ...
          return (
            <Reveal key={order.id} delay={i * 0.04}>
              <div className="flex flex-col gap-4 rounded-2xl border border-hairline/10 bg-surface p-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      {paidOrders.length > 0 && (
        <div className="mt-8 flex items-start gap-3 rounded-2xl border border-hairline/10 bg-surface2 p-5 text-sm text-mid">
